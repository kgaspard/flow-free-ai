...
def model_accuracy(model_path='models\model_five_permutations_20_epochs', build_model=False, draw=False):
    gpu.limit_gpu() # remove if using GPU tensorflow
    ...
    acc = test_accuracy(x_test,y_test,model_path,max_board_size=5,max_number_of_colours=max_val,draw=draw)
